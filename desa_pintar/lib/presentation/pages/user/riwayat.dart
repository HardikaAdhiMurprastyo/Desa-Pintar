import 'package:desa_pintar/presentation/pages/user/detail_surat_warga.dart';
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          ...
          "http://192.168.1.7/dpin_db/data_surat.php"));
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => DetailSuratWarga(
                                  no_surat: _get[index]['no_surat'],
                                ),
                              ),
                            );
                          },
                              ...
                              FittedBox(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color:
                                            Color.fromARGB(255, 104, 243, 248),
                                        width: 1),
