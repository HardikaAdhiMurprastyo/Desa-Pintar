...
class AccSurat extends StatelessWidget {
  const AccSurat({Key? key}) : super(key: key);
                ...
                children: [
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          primary: Color.fromARGB(255, 255, 255, 255),
                           onPrimary: Color.fromARGB(255, 61, 192, 145),
                          textStyle: TextStyle(
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          primary: Color.fromARGB(255, 61, 192, 145),
                          textStyle: TextStyle(
                              fontSize: 16, fontWeight: FontWeight.bold),
                          fixedSize: const Size(310, 45),
                          shape: RoundedRectangleBorder(
